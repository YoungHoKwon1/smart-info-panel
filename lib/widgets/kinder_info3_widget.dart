...
class KinderInfoWidget3 extends StatefulWidget {
  const KinderInfoWidget3({Key? key}) : super(key: key);

  @override
  State<KinderInfoWidget3> createState() => _KinderInfoWidget3State();
}

class _KinderInfoWidget3State extends State<KinderInfoWidget3> {
    ...
    return Column(
      children: [
        ...
        Container(
            ...
            child: context.watch<KinderDataProvider>().floorImage
          // Image(
