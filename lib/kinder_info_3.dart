...
class KinderInfo3 extends StatefulWidget {
  const KinderInfo3({Key? key}) : super(key: key);

  @override
  State<KinderInfo3> createState() => _KinderInfo3State();
}
                ...
                child: Column(
                  children: [
                    ...
                    Container(
                      ...
                      child: Image(image:AssetImage('assets/class_info_deco/01.png'),)
                    ),
                    ///
                    /// 각종 차트들>
                  ],
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    //               child: Text(chartRate[i].toString(),
                    //                   style: TextStyle(
                    //                     fontFamily: 'NotoSansKR',
                    //                     color: Color(0xff393838),
                    //                     fontSize: 12.sp,
